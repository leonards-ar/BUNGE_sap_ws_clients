 ...
 *
 */
public class AfipCTG20ResponseParser extends BaseResponseParser implements ResponseParser {
	private static final Logger LOG = Logger.getLogger(AfipCTG20ResponseParser.class);
	...
	private static final String CONFIRMAR_DEFINITIVO_RESPONSE_CONTAINER_NODE = "response";
	private static final String CONFIRMAR_DEFINITIVO_RESPONSE_NODES[] = {"detalle"};
	...
	private static final String CONSULTAR_DETALLE_CTG_RESPONSE_NODES[] = {"ctg", "solicitante", "cartaPorte", "estado", "fechaEmision", "fechaVigenciaDesde", "fechaVigenciaHasta", "cuitCanjeador", "remitenteComercialComoCanjeador", "cuitDestino", "cuitDestinatario", "establecimiento", "localidadOrigen", "localidadDestino", "cosecha", "cuitTransportista", "detalle", "cantidadHoras", "patenteVehiculo", "pesoNetoCarga", "kmARecorrer", "tarifaReferencia"};
	...
	private static final String SOLICITAR_CTG_DATO_PENDIENTE_HEADER_RESPONSE_NODES[] = {"observacion", "cartaPorte", "ctg", "fechaEmision", "fechaVigenciaDesde", "fechaVigenciaHasta", "tarifaReferencia"};
	...
	private static final String SOLICITAR_CTG_INICIAL_HEADER_RESPONSE_NODES[] = {"observacion", "cartaPorte", "ctg", "fechaEmision", "fechaVigenciaDesde", "fechaVigenciaHasta", "tarifaReferencia"};
	 ...
	 * 
	 */
	public AfipCTG20ResponseParser() {
	}
	...
	public static void main(String a[]) {
		try {
			AfipCTG20ResponseParser r = new AfipCTG20ResponseParser();
